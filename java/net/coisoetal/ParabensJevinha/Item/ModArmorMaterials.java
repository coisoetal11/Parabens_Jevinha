...
public enum ModArmorMaterials implements ArmorMaterial {
    SCALE_FABRIC("swim_suit", 26, new int[]{ 3, 5, 3, 2 }, 25,
            SoundEvents.ARMOR_EQUIP_LEATHER, 1f, 0f, () -> Ingredient.of(ModItems.SCALE_FABRIC.get())),
    BEDROCK("oculos", 1000000000, new int[]{ 0, 0, 0, 0 }, 0,
            SoundEvents.ARMOR_EQUIP_LEATHER, 0f, 0f, () -> Ingredient.of(Items.BEDROCK)),
    ;
    ...
    public String getName() {
        return ParabensJevinha.MOD_ID + ":" + this.name;
    }
