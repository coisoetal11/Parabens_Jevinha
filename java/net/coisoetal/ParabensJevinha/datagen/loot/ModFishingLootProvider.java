...
public class ModFishingLootProvider extends VanillaFishingLoot {
    ...
    public void generate(BiConsumer<ResourceLocation, LootTable.Builder> p_249559_) {
        ...
        p_249559_.accept(BuiltInLootTables.FISHING_FISH, fishingModFishLootTable());
    ...
    public static LootTable.Builder fishingModFishLootTable() {
        return LootTable.lootTable().withPool(LootPool.lootPool()
                .add(LootItem.lootTableItem(ModItems.ROBALO_ITEM.get()).setWeight(25))
                .add(LootItem.lootTableItem(ModItems.DOURADA_ITEM.get()).setWeight(20))
                .add(LootItem.lootTableItem(Items.COD).setWeight(20))
                .add(LootItem.lootTableItem(Items.SALMON).setWeight(20))
                .add(LootItem.lootTableItem(Items.TROPICAL_FISH).setWeight(2))
                .add(LootItem.lootTableItem(Items.PUFFERFISH).setWeight(13)));
    }

    static {
        IN_JUNGLE = LocationCheck.checkLocation(net.minecraft.advancements.critereon.LocationPredicate.Builder.location().setBiome(Biomes.JUNGLE));
        IN_SPARSE_JUNGLE = LocationCheck.checkLocation(net.minecraft.advancements.critereon.LocationPredicate.Builder.location().setBiome(Biomes.SPARSE_JUNGLE));
        IN_BAMBOO_JUNGLE = LocationCheck.checkLocation(net.minecraft.advancements.critereon.LocationPredicate.Builder.location().setBiome(Biomes.BAMBOO_JUNGLE));
    }
}
